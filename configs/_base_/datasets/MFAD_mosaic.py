...
data_root = '/home/shared_directory/datasets/MFAD/'
backend_args = None
classes = ('car', 'bus',  'truck','pedestrian','ebikerider','cyclist')
train_pipeline = [
    dict(type='PairedMixUp', img_scale=(1280, 960), pad_val=114.0, ratio_range= (0.5, 1.5)),
    # dict(type='PairedMosaic', img_scale=(1280, 960), pad_val=114.0),
    # dict(type='LoadPairedImageFromFile', to_float32=True),
    # dict(type='LoadAnnotations', with_bbox=True, with_mask=False),
    # dict(type='PairedImagesResize', scale=(1280,1024), keep_ratio=True),
    dict(type='PairedImagesResize', scale=(1280, 960), keep_ratio=True),
