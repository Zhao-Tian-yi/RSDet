...
model = dict(
    ...
    type='TwoStreamFasterRCNNCommonUnique_14th',
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/home/zhangguiwei/.cache/torch/hub/checkpoints/resnet50_cityscape.pth')
    ...
    Gcommon = dict(
        ...
        backbone=dict(
            ...
            init_cfg=dict(type='Pretrained',
                          checkpoint='/home/zhangguiwei/.cache/torch/hub/checkpoints/resnet50_cityscape.pth')
