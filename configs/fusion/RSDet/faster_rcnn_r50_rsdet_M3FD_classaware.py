_base_ = [
    '../../_base_/datasets/M3FD_ClassAwareSampler.py',
...
model = dict(
    ...
    shared_feature_generator=dict(
        type='SharedFeatureGenerator',
        loss_MI1=dict(type='MutualInfoLoss', input_channels=512),
        loss_MI2=dict(type='MutualInfoLoss', input_channels=1024),
    ...
    selection_fusion=dict(
        type='DynamicFeatureSelection',
        loss_MI=dict(type='MutualInfoLoss', input_channels=259),
        feature_nums=3,
        num_ins=4,
