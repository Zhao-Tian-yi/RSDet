...
class TwoStreamSingleStageDetector(SingleStageDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        """
        x_vis = self.extract_feat_vis(batch_inputs['img_vis'])
        x_lwir = self.extract_feat_lwir(batch_inputs['img_vis'])
        x=[]
    ...
    def extract_feat(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        ...
        if self.with_neck:
            x = self.neck(x)
        return x
    def extract_feat_vis(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        """Extract features.
        ...
        Returns:
            ...
            different resolutions.
        """
        x = self.backbone_vis(batch_inputs)
        if self.with_neck:
            x = self.neck_vis(x)
        return x
    def extract_feat_lwir(self, batch_inputs: Tensor) -> Tuple[Tensor]:
        """Extract features.
