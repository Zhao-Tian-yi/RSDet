...
class CommonFeatureGenerator3(BaseModule):
    ...
    def __init__(
        ...
        self.backbone_vis_2 = MODELS.build(backbone)
        self.backbone_lwir_2 = MODELS.build(backbone)
    ...
    def forward(self, img_vis,img_lwir):
        ...
        x_vis_ = self.backbone_vis_2(img_vis)
        x_lwir_ = self.backbone_lwir_2(img_lwir)
